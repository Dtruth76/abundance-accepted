...
const BOOKS: Book[] = [
  {
    ...
    amazonUrl: 'https://a.co/d/00nyUL7p',
    spineLabel: 'Book One',
    coverImage: '/books/wake-up-and-workout.jpg',
  },
  {
    ...
    amazonUrl: 'https://a.co/d/0iPkQd0U',
    spineLabel: 'Book Two',
    coverImage: '/books/are-you-up-for-the-challenge.jpg',
  },
]
